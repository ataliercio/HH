...
int main (int argc, char ** argv){
  ...
  for(int i=0;i<signlines;i++){
    ...
    if (site.find("CERN")<5){
      ...
      //dirInput="/lustre/cms/store/user/atalierc/mc_test/GluGluToHHTo2B2ZTo4L_node_12_13TeV-madgraph_correctedcfg/crab_20190731_163337/190731_143458/0000";
      dirInput="/lustre/cms/store/user/atalierc/HH_ZZbb_Signal/samples";
    }
    ...
    if (sigFile.Contains("2HDM") || sigFile.Contains("Baryoni") ) dirInput="/lustre/cms/store/user/defilip/MonoHiggs/Moriond17_merged_Syst";
