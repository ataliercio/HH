...
void HZZ4LeptonsAnalysis::Loop(Char_t *output)
{
   ...
   TFile *ele_RecoEff_2017_lowEt = new TFile("egammaEffi_txt_EGM2D_runBCDEF_passingRECO_lowEt.root");
   TH2F *ele_Reco_eff_2017_lowEt = (TH2F*)gDirectory->Get("EGamma_SF2D");
   TFile *ele_RecoEff_2017_highEt = new TFile("egammaEffi_txt_EGM2D_runBCDEF_passingRECO.root");
   ...
   */
   ...
   TH1D *hmassm = new TH1D("massmediumo","massmedium",180,0,180);
   TH1D *hmassl = new TH1D("massaloose","massaloose",180,0,180);
   TH1D *hmasst = new TH1D("masstight","masstight",180,0,180);
   TH1D *hmasstpm = new TH1D("masstpm","masstpm",180,0,180);

   TH1D *hbdiscsel = new TH1D("bdiscsel","bdiscsel",100,0,1);
   TH1D *hbdiscnosel = new TH1D("bdiscnosel","bdiscnosel",100,0,1);

   TH1D *hMETsel = new TH1D("metsel","metsel",200,0,200);
   TH1D *hMETnosel = new TH1D("metnosel","metnosel",200,0,200);
   TH1D *hMETmed = new TH1D("metmed","metmed",200,0,200);
   TH1D *hMETtig = new TH1D("mettig","mettig",200,0,200);
   TH1D *hMETloo = new TH1D("metloo","metloo",200,0,200);
   TH1D *hMETtpm = new TH1D("mettpm","mettpm",200,0,200);
   TH1D *histoMETprima = new TH1D("metprima","metprima",200,0,200);
   TH1D *histoMETnpm = new TH1D("metnpm","metnpm",200,0,200);


   TH1D *htot2jet = new TH1D("tot2jet","tot2jet",100,0,100);
   TH1D *htotjetm = new TH1D("totjetm","totjetm",100,0,100);
   TH1D *htotjett = new TH1D("totjett","totjett",100,0,100);
  ...
  TH1D *hmassd = new TH1D("massd","massd",200,0,200);
  ...
  TH2 *h2nobjet = new TH2D("h2nobjett","h2nobjett",300,0,300,100,0,1);
  TH2 *h2bjet = new TH2D("h2bjett","h2bjett",300,0,300,100,0,1);
  ...
  TH2 *h2nobjetnpm = new TH2D("h2nobjet","h2nobjet",300,0,300,100,0,1);
  TH2 *h2bjetnpm = new TH2D("h2bjet","h2bjet",300,0,300,100,0,1);
  ...
  TH1D *hn_2e2mujet = new TH1D("hn_2e2mujet","hn_2e2mujet",200,0,200);
  ...
  TH1D *PT_fakeelectron_loose_barrel = new TH1D("PT_fakeelectron_loose_barrel","PT_fakeelectron_loose_barrel",300,0,300);
  TH1D *MET_fakeelectron_loose_barrel = new TH1D("MET_fakeelectron_loose_barrel","MET_fakeelectron_loose_barrel",300,0,300);
  TH1D *Z1_fakemasslooseelectron_barrel = new TH1D("Z1_fakemasslooseelectron_barrel","Z1_fakemasslooseelectron_barrel",200,0,200);
  
  TH1D *PT_fakeelectron_tight_barrel = new TH1D("PT_fakeelectron_tight_barrel","PT_fakeelectron_tight_barrel",300,0,300);
  TH1D *MET_fakeelectron_tight_barrel = new TH1D("MET_fakeelectron_tight_barrel","MET_fakeelectron_tight_barrel",300,0,300);
  TH1D *Z1_fakemasstightelectron_barrel = new TH1D("Z1_fakemasstightelectron_barrel","Z1_fakemasstightelectron_barrel",200,0,200);

  TH1D *PT_fakeelectron_loose_endcap = new TH1D("PT_fakeelectron_loose_endcap","PT_fakeelectron_loose_endcap",300,0,300);
  TH1D *MET_fakeelectron_loose_endcap = new TH1D("MET_fakeelectron_loose_endcap","MET_fakeelectron_loose_endcap",300,0,300);
  TH1D *Z1_fakemasslooseelectron_endcap = new TH1D("Z1_fakemasslooseelectron_endcap","Z1_fakemasslooseelectron_endcap",200,0,200);
  
  TH1D *PT_fakeelectron_tight_endcap = new TH1D("PT_fakeelectron_tight_endcap","PT_fakeelectron_tight_endcap",300,0,300);
  TH1D *MET_fakeelectron_tight_endcap = new TH1D("MET_fakeelectron_tight_endcap","MET_fakeelectron_tight_endcap",300,0,300);
  TH1D *Z1_fakemasstightelectron_endcap = new TH1D("Z1_fakemasstightelectron_endcap","Z1_fakemasstightelectron_endcap",200,0,200);

  TH1D *PT_fakemuon_loose_barrel = new TH1D("PT_fakemuon_loose_barrel","PT_fakemuon_loose_barrel",300,0,300);
  TH1D *MET_fakemuon_loose_barrel = new TH1D("MET_fakemuon_loose_barrel","MET_fakemuon_loose_barrel",300,0,300);
  TH1D *Z1_fakemassloosemuon_barrel = new TH1D("Z1_fakemassloosemuon_barrel","Z1_fakemassloosemuon_barrel",200,0,200);
  
  TH1D *PT_fakemuon_tight_barrel = new TH1D("PT_fakemuon_tight_barrel","PT_fakemuon_tight_barrel",300,0,300);
  TH1D *MET_fakemuon_tight_barrel = new TH1D("MET_fakemuon_tight_barrel","MET_fakemuon_tight_barrel",300,0,300);
  TH1D *Z1_fakemasstightmuon_barrel = new TH1D("Z1_fakemasstightmuon_barrel","Z1_fakemasstightmuon_barrel",200,0,200);

  TH1D *PT_fakemuon_loose_endcap = new TH1D("PT_fakemuon_loose_endcap","PT_fakemuon_loose_endcap",300,0,300);
  TH1D *MET_fakemuon_loose_endcap = new TH1D("MET_fakemuon_loose_endcap","MET_fakemuon_loose_endcap",300,0,300);
  TH1D *Z1_fakemassloosemuon_endcap = new TH1D("Z1_fakemassloosemuon_endcap","Z1_fakemassloosemuon_endcap",200,0,200);
  
  TH1D *PT_fakemuon_tight_endcap = new TH1D("PT_fakemuon_tight_endcap","PT_fakemuon_tight_endcap",300,0,300);
  TH1D *MET_fakemuon_tight_endcap = new TH1D("MET_fakemuon_tight_endcap","MET_fakemuon_tight_endcap",300,0,300);
  TH1D *Z1_fakemasstightmuon_endcap = new TH1D("Z1_fakemasstightmuon_endcap","Z1_fakemasstightmuon_endcap",200,0,200);
  ...
  TH1D *Z1_fakejetmasstight_endcap = new TH1D("Z1_fakejetmasstight_endcap","Z1_fakejetmasstight_endcap",200,0,200);
   ...
   Int_t f_category,f_Ngood,f_Nbjets;
     ...
     //Addo other branches
  Float_t f_deltaphi, f_deltar, f_MET, f_deltar_2med, f_deltaphi_2med, f_MET_2med, f_deltar_norm, f_deltaphi_norm, f_MET_norm, f_pt3;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {//nentries
	...
	continue;
          ...
          for(int i = 0; i < 2; ++i){
            ...
            if( (MC_type == "Fall17") && DATA_type == "NO"){
              ...
              if(RECOELE_isGap[ z1lept[i] ]==0){
                ...
                Int_t biny = ele_scale_2017->GetYaxis()->FindBin(Pt);
                ...
                Int_t biny = ele_scale_2017_gap->GetYaxis()->FindBin(Pt);
	  ...
	  for(int i = 0; i < 2; ++i){
	    Double_t Pt = RECOELE_PT[ z1lept[i] ];
	    Double_t Eta = RECOELE_ETA[ z1lept[i] ];
	    Double_t SC_Eta = RECOELE_scl_Eta[ z1lept[i] ];
...
cout << "FR for electron " << "\n";

float deltar_fakeelectron_1, deltar_fakeelectron_2;
float deltar_fakemuon_1, deltar_fakemuon_2;
...
int N_loose = N_loose_e + N_loose_mu;

cout << "good electrons before fr calculation "<< N_loose_e << "\n";
cout << "good muons before fr calculation "<< N_loose_mu << "\n";
if(Zcandisolmassvector.at(index).tag == 2){ //ee
...
if(N_loose_e == 3 && ngood_jets >=2){//control region 2 good leptons + 1 fake leptons + 2 good jets
 ...
 if(iL_loose_e[i] != (Zcandisolmassvector.at(index).ilept1 && Zcandisolmassvector.at(index).ilept2)){
  ...
  deltar_fakeelectron_1 = sqrt( pow(DELTAPHI(RECOMU_PHI[iL_loose_e[i]],Zcandisolmassvector.at(index).phi1),2) + pow(RECOMU_ETA[iL_loose_e[i]] - Zcandisolmassvector.at(index).eta1,2));
  deltar_fakeelectron_2 = sqrt( pow(DELTAPHI(RECOMU_PHI[iL_loose_e[i]],Zcandisolmassvector.at(index).phi2),2) + pow(RECOMU_ETA[iL_loose_e[i]] - Zcandisolmassvector.at(index).eta2,2));
  
 if (fabs( RECOMU_SIP[iL_loose_e[i]] ) < 4. && (deltar_fakeelectron_1 > 0.02 && deltar_fakeelectron_2 > 0.02)){

cout << "loose fake electron pt (fr calculation) "<< RECOMU_PT[iL_loose_e[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_e[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_e[i]]<< "\n"
    << "and deltar1 " << deltar_fakeelectron_1 << " and deltar2 " << deltar_fakeelectron_2 << "\n"
    << "and position " << iL_loose_e[i] << "\n";

//taking the histogram for the fake muons
    if(fabs (RECOMU_ETA[iL_loose_e[i]]) <= 1.2){ //barrel
    cout << "loose barrel fake electron pt (fr calculation) "<< RECOMU_PT[iL_loose_e[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_e[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_e[i]]<< "\n"
    << "and deltar1 " << deltar_fakeelectron_1 << " and deltar2 " << deltar_fakeelectron_2 << "\n"
    << "and position " << iL_loose_e[i] << "\n";

       PT_fakeelectron_loose_barrel->Fill(RECOMU_PT[iL_loose_e[i]], newweight);
       MET_fakeelectron_loose_barrel->Fill(RECO_PFMET,newweight);
       Z1_fakemasslooseelectron_barrel->Fill(Zcandisolmassvector.at(index).massvalue, newweight);
       }else{//endcap
           cout << "loose endcap fake electron pt (fr calculation) "<< RECOMU_PT[iL_loose_e[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_e[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_e[i]]<< "\n"
    << "and deltar1 " << deltar_fakeelectron_1 << " and deltar2 " << deltar_fakeelectron_2 << "\n"
    << "and position " << iL_loose_e[i] << "\n";

         PT_fakeelectron_loose_endcap->Fill(RECOMU_PT[iL_loose_e[i]], newweight);
         MET_fakeelectron_loose_endcap->Fill(RECO_PFMET,newweight);
         Z1_fakemasslooseelectron_endcap->Fill(Zcandisolmassvector.at(index).massvalue, newweight); 
         }
...
//if the fake muon pass also the tight criteria...
    ...
    cout << "tight fake electron pt (fr calculation) "<< RECOMU_PT[iL_loose_e[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_e[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_e[i]]<< "\n"
    << "and deltar1 " << deltar_fakeelectron_1 << " and deltar2 " << deltar_fakeelectron_2 << "\n"
    << "and position " << iL_loose_e[i] << "\n";
    ...
    if(fabs (RECOMU_ETA[iL_loose_e[i]]) <= 1.2){ //barrel
    cout << "tight barrel fake electron pt (fr calculation) "<< RECOMU_PT[iL_loose_e[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_e[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_e[i]]<< "\n"
    << "and deltar1 " << deltar_fakeelectron_1 << " and deltar2 " << deltar_fakeelectron_2 << "\n"
    << "and position " << iL_loose_e[i] << "\n";

       PT_fakeelectron_tight_barrel->Fill(RECOMU_PT[iL_loose_e[i]], newweight);
       MET_fakeelectron_tight_barrel->Fill(RECO_PFMET,newweight);
       Z1_fakemasstightelectron_barrel->Fill(Zcandisolmassvector.at(index).massvalue, newweight);
       }else{//endcap
    cout << "tight endcap fake electron pt (fr calculation) "<< RECOMU_PT[iL_loose_e[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_e[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_e[i]]<< "\n"
    << "and deltar1 " << deltar_fakeelectron_1 << " and deltar2 " << deltar_fakeelectron_2 << "\n"
    << "and position " << iL_loose_e[i] << "\n";

         PT_fakeelectron_tight_endcap->Fill(RECOMU_PT[iL_loose_e[i]], newweight);
         MET_fakeelectron_tight_endcap->Fill(RECO_PFMET,newweight);
         Z1_fakemasstightelectron_endcap->Fill(Zcandisolmassvector.at(index).massvalue, newweight); 
                }
            }
         }
        }
  ...
  if(Zcandisolmassvector.at(index).tag == 1){ //mumu   
 
// if(N_loose_mu == 3 && ngood_jets >=2){//control region 2 good leptons + 1 fake leptons + 2 good jets
...
if(iL_loose_mu[i] != (Zcandisolmassvector.at(index).ilept1 && Zcandisolmassvector.at(index).ilept2)){
  ...
  deltar_fakemuon_1 = sqrt( pow(DELTAPHI(RECOMU_PHI[iL_loose_mu[i]],Zcandisolmassvector.at(index).phi1),2) + pow(RECOMU_ETA[iL_loose_mu[i]] - Zcandisolmassvector.at(index).eta1,2));
  deltar_fakemuon_2 = sqrt( pow(DELTAPHI(RECOMU_PHI[iL_loose_mu[i]],Zcandisolmassvector.at(index).phi2),2) + pow(RECOMU_ETA[iL_loose_mu[i]] - Zcandisolmassvector.at(index).eta2,2));
  
 if (fabs( RECOMU_SIP[iL_loose_mu[i]] ) < 4. && (deltar_fakemuon_1 > 0.02 && deltar_fakemuon_2 > 0.02)){
    ...
    << "and deltar1 " << deltar_fakemuon_1 << " and deltar2 " << deltar_fakemuon_2 << "\n"
    << "and position " << iL_loose_mu[i] << "\n";


//taking the histogram for the fake muons
    if(fabs (RECOMU_ETA[iL_loose_mu[i]]) <= 1.2){ //barrel
        cout << "loose barrel fake muon pt (fr calculation) "<< RECOMU_PT[iL_loose_mu[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_mu[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_mu[i]]<< "\n"
    << "and deltar1 " << deltar_fakemuon_1 << " and deltar2 " << deltar_fakemuon_2 << "\n"
    << "and position " << iL_loose_mu[i] << "\n";

       PT_fakemuon_loose_barrel->Fill(RECOMU_PT[iL_loose_mu[i]], newweight);
       MET_fakemuon_loose_barrel->Fill(RECO_PFMET,newweight);
       Z1_fakemassloosemuon_barrel->Fill(Zcandisolmassvector.at(index).massvalue, newweight);
       }else{//endcap
        cout << "loose endcap fake muon pt (fr calculation) "<< RECOMU_PT[iL_loose_mu[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_mu[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_mu[i]]<< "\n"
    << "and deltar1 " << deltar_fakemuon_1 << " and deltar2 " << deltar_fakemuon_2 << "\n"
    << "and position " << iL_loose_mu[i] << "\n";

         PT_fakemuon_loose_endcap->Fill(RECOMU_PT[iL_loose_mu[i]], newweight);
         MET_fakemuon_loose_endcap->Fill(RECO_PFMET,newweight);
         Z1_fakemassloosemuon_endcap->Fill(Zcandisolmassvector.at(index).massvalue, newweight); 
         }
...
cout << "tight fake muon pt (fr calculation) "<< RECOMU_PT[iL_loose_e[i]] << "and eta " << RECOMU_ETA[iL_loose_e[i]] << "and position " << iL_loose_e[i] << "\n";
        cout << "tight fake muon pt (fr calculation) "<< RECOMU_PT[iL_loose_mu[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_mu[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_mu[i]]<< "\n"
    << "and deltar1 " << deltar_fakemuon_1 << " and deltar2 " << deltar_fakemuon_2 << "\n"
    << "and position " << iL_loose_mu[i] << "\n";
    ...
    if(fabs (RECOMU_ETA[iL_loose_mu[i]]) <= 1.2){ //barrel
        cout << "tight barrel fake muon pt (fr calculation) "<< RECOMU_PT[iL_loose_mu[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_mu[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_mu[i]]<< "\n"
    << "and deltar1 " << deltar_fakemuon_1 << " and deltar2 " << deltar_fakemuon_2 << "\n"
    << "and position " << iL_loose_mu[i] << "\n";
       ...
       PT_fakemuon_tight_barrel->Fill(RECOMU_PT[iL_loose_mu[i]], newweight);
       MET_fakemuon_tight_barrel->Fill(RECO_PFMET,newweight);
       Z1_fakemasstightmuon_barrel->Fill(Zcandisolmassvector.at(index).massvalue, newweight);
       }else{//endcap

        cout << "tight endcap fake muon pt (fr calculation) "<< RECOMU_PT[iL_loose_mu[i]] << "\n"
    << "and eta " << RECOMU_ETA[iL_loose_mu[i]] << "\n"
    << "and SIP " << RECOMU_SIP[iL_loose_mu[i]]<< "\n"
    << "and deltar1 " << deltar_fakemuon_1 << " and deltar2 " << deltar_fakemuon_2 << "\n"
    << "and position " << iL_loose_mu[i] << "\n";

         PT_fakemuon_tight_endcap->Fill(RECOMU_PT[iL_loose_mu[i]], newweight);
         MET_fakemuon_tight_endcap->Fill(RECO_PFMET,newweight);
         Z1_fakemasstightmuon_endcap->Fill(Zcandisolmassvector.at(index).massvalue, newweight); 
                }
            }
         }
      }
    ...
    //ZcandittZ.clear();
N_tot = Ne_good + N_good;
if(N_tot >=2 && njets_pass >= 2){
    ...
    double delta_R1_1, delta_R2_1, delta_R2_2, delta_R1_2;
	...
	for(int i = 0; i < 2; ++i){
      ...
      if (Z2tag==1){ 
        ...
        for(int i = 0; i < 2; ++i){
          Double_t Pt = RECOELE_PT[ z2lept[i] ];
          Double_t Eta = RECOELE_ETA[ z2lept[i] ];
          Double_t SC_Eta = RECOELE_scl_Eta[ z2lept[i] ];
...
//       }
     ...
     if(njets_pass >= 2){tot2jet++;
       ...
       //hmass4l->Fill(mass4l);
       //hbdiscsel -> Fill(cSV_BTagJet_DISCR[i]);
       //hMETsel ->Fill(RECO_PFMET);
     }
...
if(N_loose_e == 3 && njets_pass >=2){//control region 2 good leptons + 1 fake leptons + 2 good jets
...
if(N_tot >= 4 && njets_pass >= 1 && fabs(RECO_PFJET_ETA[i]) < 4.7){//jets inside the acceptance
...
//}//QUELLA DELL'IF IMPORTANTISSIMA     
     ...
     /* TLorentzVector k1m, k2m, massm;
     TLorentzVector k1l, k2l, massl;
     TLorentzVector k1t, k2t, masst;
     TLorentzVector masstpm;*/
     ...
     TLorentzVector masstot, masstotm, masstotl, masstottpm, masstott;
     double deltaphi = -999., deltaphim = -999., deltaphil= -999., deltaphit = -999., deltaphitpm = -999., deltar = -999.;
     double deltarnpm = -999.;
     hmass4l->Fill(mass4l,newweight);
     if(N_good == 2 && Ne_good ==2 && njets_pass >=2){
       hn_2e2mujet->Fill(mass4l,newweight);
   ...
   for(int j=0; j<RECO_PFJET_N; j++){
     if(j!=flagicontrol && jetfail[j] ==0){
       ...
       if(flagbmjcontrol < cSV_BTagJet_DISCR[j]){
	 flagbmjcontrol = cSV_BTagJet_DISCR[j];
	 flagjcontrol = j;
       }
     }
   }
   ...
   histoMETprima->Fill(RECO_PFMET,newweight);
     if((N_good >= 2 && Ne_good >= 2) && abs(mass4l - 125.) <= 10 && njets_pass >=2){
       hmass4lafter->Fill(mass4l,newweight);
       tot2jet4l++;
       hMETsel->Fill(RECO_PFMET,newweight);
       for(int i = 0; i<RECO_PFJET_N; i++){

       if(njets_pass >= 2 && jetfail[i] ==0){
	 hbdiscsel -> Fill(cSV_BTagJet_DISCR[i],newweight);
	 //hMETsel ->Fill(RECO_PFMET);
       }else{hbdiscnosel -> Fill(cSV_BTagJet_DISCR[i],newweight);
	 ...
	 n_jett++;
       ...
       if(jetfail[i] == 0){
	 if(flagbi < cSV_BTagJet_DISCR[i]){
	   flagbi = cSV_BTagJet_DISCR[i];
	   flagi = i;
	 }
       }
     }
	 ...
	 if(flagbj < RECO_PFJET_PT[j]){
	   flagbj = RECO_PFJET_PT[j];
	   flagj = j;
	 }	   
       }  
     }
     /*
     int flagik = -999., flagk = -99.;
     for(int k = 0; k < RECO_PFJET_N; k++){
       if(jetfail[k] ==0 && n_jetm >= 1 && k != flagi && k!= flagj){
     ...
     */ 
     int flagil = -999., flagill = -999., flagl = -99., flagll =-999.;
   ...
   prova->Fill(massprova.M(),newweight);
     ...
     hbdiscmin->Fill(cSV_BTagJet_DISCR[flagj],newweight);
    ...
    deltaphi = DELTAPHI(mass.Phi(), hP4.Phi());
    ...
    deltar =sqrt(deltaphi*deltaphi + (mass.Eta() - hP4.Eta())*(mass.Eta()-hP4.Eta()));
   ...
   f_deltar_norm = deltar;
   f_deltaphi_norm = deltaphi;

   f_deltar_jethighestpt = deltar_jethighestpt;
   f_deltaphi_jethighestpt = deltaphi_jethighestpt;

   f_MET_norm = RECO_PFMET;
   
   f_bdiscjet1 = cSV_BTagJet_DISCR[flagi];
   f_bdiscjet2 = cSV_BTagJet_DISCR[flagj];
  ...
  f_phijet2 = RECO_PFJET_PHI[flagj];
   ...
   if((N_good == 2 && Ne_good == 2) && RECO_PFJET_PT[flagk] <= 50){
	...
	leptons2bjets++;	
       ...
       htotjetm -> Fill(totjetm,newweight);
       hmassm -> Fill(mass.M(),newweight);
       hMETmed->Fill(RECO_PFMET,newweight);
       masstotm = mass + hP4;
       hmasstotm -> Fill(masstotm.M(),newweight);
       deltaphim = abs(mass.Phi() - hP4.Phi());
       hdeltaphim -> Fill(deltaphim,newweight);     

     }
     if(n_jett >= 2){totjett++;
       htotjett->Fill(totjett,newweight);
       hmasst -> Fill(mass.M(),newweight);
       hMETtig->Fill(RECO_PFMET,newweight);
       masstott = mass + hP4;
       hmasstott -> Fill(masstott.M(),newweight);
       deltaphit = abs(mass.Phi() - hP4.Phi());
       hdeltaphit -> Fill(deltaphit,newweight);
     }
     if(n_jetl >= 2){totjetl++;
       htotjetl->Fill(totjetl,newweight);
       hmassl -> Fill(mass.M(),newweight);
       hMETloo->Fill(RECO_PFMET,newweight);
       masstotl = mass + hP4;
       hmasstotl -> Fill(masstotl.M(),newweight);
       deltaphil = abs(mass.Phi() - hP4.Phi());
       hdeltaphil -> Fill(deltaphil,newweight);
     }
     if(n_jetm >=2 && n_jett >=1){totjettpm++;
       htotjettpm->Fill(totjettpm,newweight);
       hmasstpm -> Fill(mass.M(),newweight);
       hMETtpm->Fill(RECO_PFMET,newweight);
       masstottpm = mass + hP4;
       hmasstottpm -> Fill(masstottpm.M(),newweight);
       deltaphitpm = abs(mass.Phi() - hP4.Phi());
   ...
   output_txt << "N_0 "  << N_0  << " \n" 
	      ...
	      << "N_9_PFMET "<< N_9_PFMET << " \n"
	      << "N_10 " << N_10 << " \n"
	      << "Eventi con 2 jet "<< tot2jet << "\n"
	      << "Eventi con 2 jet e 4l "<<tot2jet4l<<"\n"
     //<< "Eventi con 2jet e 4l precisi "<<n_2e2mujet<<"\n"
     //<< "Eventi con 2jet + 4l precisi + abs(mass4l - 125) <= 10 "<< n_2e2mujetmass<<"\n"
	      << "Eventi con 2 jet medi "<<totjetm << "\n"
	      << "Eventi con 2 jet loose "<<totjetl << "\n"
	      << "Eventi con 2 jet tight "<<totjett << "\n"
	      << "Eventi tight + medio "<< totjettpm << "\n"
	      << "Eventi normale + medio "<< totjetnpm<< "\n"
	      << "Eventi normale + tight "<<totjetnpt<< "\n"
	      ...
	      << "\\\\\\ + 3 jet + 4 lept "<<hmassnpm3->Integral(0,200)<<"\n"
   	       ...
   	       << "Numero eventi |...| <= 10 && nlept <=4 && njet >=2 "<<tot2jet4l<<"\n"
	       << "Numero eventi |...| <= 10 && nlept <=4 && nbjet >=2 "<<totjetm<<"\n"
	       << "Numero eventi |...| <= 10 && nlept <=4 && nbjet >=1 "<<totjetnpm<<"\n"
	       
	       << "Numero eventi |...| <= 10 && nlept ==4 && njet >=2 "<<n_2e2mujetmass<<"\n"
