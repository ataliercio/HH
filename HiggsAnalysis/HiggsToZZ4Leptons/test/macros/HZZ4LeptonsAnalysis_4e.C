...
void HZZ4LeptonsAnalysis::Loop(Char_t *output)
{
   ...
   */
   ...
   TH1F * hMZ_3_met_low60 = new TH1F("hMZ_3_met_low60", "Mass of Z after selection step 3 in met<=60", 200 , -0.5 , 199.5 );
   hMZ_3_met_low60->SetXTitle("mass_Z  (GeV)");
   TH1F * hMZ_3_met_grt60 = new TH1F("hMZ_3_met_grt60", "Mass of Z after selection step 3 in met>60", 200 , -0.5 , 199.5 );
   hMZ_3_met_grt60->SetXTitle("mass_Z  (GeV)");
   TH1F * hZ_lep1_pt_3 = new TH1F("hZ_lep1_pt", "Pt of Lep1 from Z after selection step 3", 500 , -0.5 , 499.5 );
   hZ_lep1_pt_3->SetXTitle("pt_Lep  (GeV)");
   TH1F * hZ_lep2_pt_3 = new TH1F("hZ_lep2_pt", "Pt of Lep2 from Z after selection step 3", 500 , -0.5 , 499.5 );
   hZ_lep2_pt_3->SetXTitle("pt_Lep  (GeV)");
   ...
   hYZ_3->SetXTitle("Y_Z");
   TH1F *hPTZ_3= new TH1F("hPTZ_3", "Pt of Z after selection step 3", 200 , -0.5 , 199.5 );//Reham new
   hPTZ_3->SetXTitle("pt_Z  (GeV)");
   ...
   TH1F * hPFMET_7_nofilter = new TH1F("hPFMET_7_nofilter", "hPFMET_7_nofilter", 1000 , 0., 1000.);
   TH1F * hPFMET_8_nofilter = new TH1F("hPFMET_8_nofilter", "hPFMET_8_nofilter", 1000 , 0., 1000.);
   TH1F * hPFMET_3_blind = new TH1F("hPFMET_3_blind", "PF MET after selection step 3 blind", 1000 , 0., 1000.);
   TH1F * hPFMET_7_blind = new TH1F("hPFMET_7_blind", "PF MET after selection step 7 blind", 1000 , 0., 1000.);
   TH1F * hPFMET_8_blind = new TH1F("hPFMET_8_blind", "PF MET after selection step 8 blind", 1000 , 0., 1000.);
   TH1F * hPFMET_9_blind = new TH1F("hPFMET_9_blind", "PF MET after selection step 9 blind", 1000 , 0., 1000.);
   TH1F * hPFMET_10_blind = new TH1F("hPFMET_10_blind", "PF MET after selection step 10 blind", 1000 , 0., 1000.);
   TH1F * hPFMET_3_nofilter_blind = new TH1F("hPFMET_3_nofilter_blind", "hPFMET_3_nofilter blind", 1000 , 0., 1000.);
   TH1F * hPFMET_7_nofilter_blind = new TH1F("hPFMET_7_nofilter_blind", "hPFMET_7_nofilter blind", 1000 , 0., 1000.);
   TH1F * hPFMET_8_nofilter_blind = new TH1F("hPFMET_8_nofilter_blind", "hPFMET_8_nofilter blind", 1000 , 0., 1000.);
   TH1F *hLogLinXPFMET_3_blind    = new TH1F("hLogLinXPFMET_3_blind","hLogLinXPFMET_3_blind",NMOBINS, loglinMbins);
   TH1F *hLogLinXPFMET_7_blind    = new TH1F("hLogLinXPFMET_7_blind","hLogLinXPFMET_7_blind",NMOBINS, loglinMbins);
   TH1F *hLogLinXPFMET_8_blind    = new TH1F("hLogLinXPFMET_8_blind","hLogLinXPFMET_8_blind",NMOBINS, loglinMbins);
   TH1F *hLogLinXPFMET_10_blind    = new TH1F("hLogLinXPFMET_10_blind","hLogLinXPFMET_10_blind",NMOBINS, loglinMbins);
  ...
  TH1D *hmassnpm2 =new TH1D("hmassnpm2","hmassnpm2",200,0,200);
...
//Add other branches
   ...
   for (Long64_t jentry=0; jentry<100000;jentry++) {
	...
	int z1lept[2]={ipt1_3,ipt2_3};
        ...
        if (RECO_PFMET<= 60)hMZ_3_met_low60->Fill(Zcandisolmassvector.at(index).massvalue,newweight );
        if (RECO_PFMET> 60)hMZ_3_met_grt60->Fill(Zcandisolmassvector.at(index).massvalue,newweight );
        hZ_lep1_pt_3->Fill(Zcandisolmassvector.at(index).pt1,newweight);
        hZ_lep2_pt_3->Fill(Zcandisolmassvector.at(index).pt2,newweight);
        double PTZ_3 = sqrt( Zcandisolmassvector.at(index).pxZ * Zcandisolmassvector.at(index).pxZ +  Zcandisolmassvector.at(index).pyZ * Zcandisolmassvector.at(index).pyZ);
        hPTZ_3->Fill(PTZ_3,newweight);
...
if(Ne_good >= 4 && njets_pass >= 1 && fabs(RECO_PFJET_ETA[i]) < 4.7){//jets inside the acceptance
...
//}//QUELLA DELL'IF IMPORTANTISSIMA
   ...
   hdeltaphip->Fill(deltaphip,newweight);
     ...
     double deltarnpm = -99.;
     if(Ne_good == 4 && njets_pass >=2){
       hn_4ejet4l->Fill(mass4l, newweight);
       if(abs(mass4l -125.) <= 10){
	 n_4ejetmass++;
  ...
  f_phijet2 = RECO_PFJET_PHI[flagj];
   ...
   f_totbjet = n_jetm;
    ...
    if(n_jetm >=1){
      ...
      if(Ne_good == 4 && abs(mass4l -125.)<=10){   
   ...
   if(Ne_good == 4 && RECO_PFJET_PT[flagk] <= 50){
       contatore2++;
...
//   if( has_FSR_Z1 || has_FSR_Z2 ) //cout << " FSR " << endl;	
   ...
   output_txt << "N_0 "  << N_0  << " \n" 
	      ...
	      << "Eventi con 2 jet + 4l "<<tot2jet4l<<"\n"
     //<< "Evetni con 2jet + 4l precisi "<<hn_4ejet4l->Integral(0,200)<<"\n"
     //  << "Eventi con 2jet +4l precisi + |mass4l -125.|<=10 "<<hmass4ltight->Integral(0,200)<<"\n"
	      ...
	      << "Eventi >= 2jet + 4l precisi "<<hn_4ejet4l->Integral(0,200)<<"\n"
	      ...
	      << "\\\\\\ + 3 jet + 4 lept "<<hmassnpm3->Integral(0,200)<<"\n"
	       ...
	       << "Numero eventi |...| <= 10 && nlept ==4 && njet >=2 "<<n_4ejetmass<<"\n"
